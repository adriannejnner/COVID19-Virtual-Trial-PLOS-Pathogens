...
% VIRUS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p.V0         = 10;         % initial virus Copies/mL
...
p.d_V        = 1.8143;               % decay rate of viruses (turned off when immune presence is considered)
p.phat       = 7.521*1e-5*1e9;            %lytic viral production rate
...
%Epithelial cell %------------------------------------
p.S0        = (19+44+73)/843;         % initial alveolar type I +alveolar type II + epithelial cells x 10^9
...
% IL-6 --------------------------------------------------------
p.L_U_0 = 7;             % Initial GM-CSF (unbound) in ng/mL
