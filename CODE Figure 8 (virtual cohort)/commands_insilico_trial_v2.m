...
patients_full_cohort = [patients_new];%([12    86   184   187   200   343   368]-4,:)];
...
for jj = 1:length(patients_full_cohort)
...
save('Patient responsesNEW_1.mat','time_grid','minimum_tissue','max_neutrophils','max_IL6','IFN_exposure','IFN_peak','max_T_cells','max_inflam_macs','max_monocytes','sol_virus','sol_tissue','sol_infected','sol_dead','sol_macs_res','sol_macs_inflam','sol_neutrophils','sol_monocytes','sol_Tcells','sol_IL6','sol_IFN','sol_GCSF')
...
set(gca,'FontSize',18)
[R,P] = corrcoef(sorted,real(max_neutrophils(where)));
text(2.05,8.5e6,['R = ' num2str(R(1,2)) ', p = ' num2str(P(1,2))],'FontSize',14)
...
set(gca,'FontSize',18)
[R,P] = corrcoef(sorted,real(max_inflam_macs(where)));
text(2.05,11*1e4,['R = ' num2str(R(1,2)) ', p = ' num2str(P(1,2))],'FontSize',14)
...
set(gca,'FontSize',18)
[R,P] = corrcoef(sorted,real(max_T_cells(where)));
text(2.05,2.7*1e6,['R = ' num2str(R(1,2)) ', p = ' num2str(P(1,2))],'FontSize',14)
...
figure
hold on
for ii = 1:size(patients_full_cohort,1)
...
colormap(colmap)
c = colorbar;
set(c,'ticks',linspace(0,1,10),'ticklabels',{'1.6', '3.1', '4.6', '6.1', '7.6','9.2','10.6','12.2','13.7','15.2'})
...
ylabel('p_{F,I}')
set(gca,'FontSize',18)
[R,P] = corrcoef(IFN_peak(where),patient(where,4));
text(2,7.5,['R = ' num2str(R(1,2)) ', p = ' num2str(P(1,2))],'FontSize',14)
colormap(colmap)
c = colorbar;
set(c,'ticks',linspace(0,1,10),'ticklabels',{'1.6', '3.1', '4.6', '6.1', '7.6','9.2','10.6','12.2','13.7','15.2'})
...
c = colorbar;
set(c,'ticks',linspace(0,1,10),'ticklabels',{'1.6', '3.1', '4.6', '6.1', '7.6','9.2','10.6','12.2','13.7','15.2'})
saveas(gcf,'Fig_8Jjj.fig');
saveas(gcf,'Fig_8Jjj.png');
...
colormap(colmap)
c = colorbar;
set(c,'ticks',linspace(0,1,10),'ticklabels',{'0.5','0.8','1.1','1.3','1.6','1.9','2.1','2.4','2.6','2.9'})
set(gca,'FontSize',18)
...
%% Virtual cohort dynamics and physiological ranges
...
hold on
plot(time_grid,sol_virus,'Color',[0.5 0.5 0.5],'LineWidth',0.5)

figure
hold on 
plot(time_IFN,lb_IFN)
plot(time_IFN,ub_IFN)
set(gca,'yscale','log')
hold on
plot(time_grid,sol_IFN,'Color',[0.5 0.5 0.5],'LineWidth',0.5)
xlim([0 15])
...
plot(time_grid/3+2,sol_IL6,'Color',[0.5 0.5 0.5],'LineWidth',0.5)
ylabel('pg/ml')
set(gca,'FontSize',20)
title('IL-6')
%set(gca,'xticklabels',{''})
set(gca,'yscale','log')
xlim([0 9])
set(gca,'xtick',[1 linspace(0,20,5)/3+2],'xticklabels',{'IL-6','0','5','10','15','20'})
xlabel('Time (days)')
...
plot(time_grid/3+2,sol_GCSF*1e3,'Color',[0.5 0.5 0.5],'LineWidth',0.5)
ylabel('pg/ml')
set(gca,'FontSize',20)
title('G-CSF')
xlim([0 9])
set(gca,'xtick',[1 linspace(0,20,5)/3+2],'xticklabels',{'G-CSF','0','5','10','15','20'})

figure
hold on 
plot(time_GCSF,lb_GCSF)
plot(time_GCSF,ub_GCSF)
set(gca,'yscale','log')
hold on
plot(time_grid,sol_GCSF,'Color',[0.5 0.5 0.5],'LineWidth',0.5)
xlim([0 15])
